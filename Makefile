...
fsmeta-rust-smoke:
	...
	go test -tags rust_raftstore -count=1 ./fsmeta/runtime/raftstore -run 'TestRustMetadataPlane(FsmetaRuntimeEndToEnd|PassesFSMetaContract|RouteSurvivesCoordinatorRebuild)'
