...
| Topic | Location |
|---|---|
| TLA+ / TLC models for control-plane and metadata transition safety | [`spec/`](https://github.com/feichai0017/NoKV/tree/main/spec) · [spec/README.md](https://github.com/feichai0017/NoKV/blob/main/spec/README.md) |
| Checked artifacts | [`spec/artifacts/`](https://github.com/feichai0017/NoKV/tree/main/spec/artifacts) |
...
| **[Formal specs](https://github.com/feichai0017/NoKV/blob/main/spec/README.md)** | TLA+ / TLC models for transition safety |
