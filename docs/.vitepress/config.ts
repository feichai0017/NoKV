      ...
      sidebar: {
        '/guide/': [
          ...
          },
          {
            ...
            collapsed: true,
            items: [
              { text: 'WAL', link: '/guide/wal' },
              { text: 'Memtable', link: '/guide/memtable' },
              { text: 'Flush', link: '/guide/flush' },
              { text: 'Compaction', link: '/guide/compaction' },
              { text: 'Landing Buffer', link: '/guide/landing_buffer' },
