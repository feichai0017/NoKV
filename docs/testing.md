...
| Request cancel / deadline propagation | Covered | `raftstore/client/client_test.go::TestClientGetHonorsCanceledContextDuringRouteLookup`, `raftstore/client/client_test.go::TestClientGetHonorsCanceledContextDuringRPC`, `raftstore/client/client_test.go::TestClientPutHonorsCanceledContextDuringRouteLookup`, `raftstore/client/client_test.go::TestClientPutHonorsCanceledContextDuringRPC` | Verifies both read and write client paths surface caller cancellation through route lookup and RPC boundaries instead of hiding it behind background contexts. |
