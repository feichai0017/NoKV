...
- **Benchmark artefacts** – stored under `benchmark/results/` for shared suites and under suite-local result directories where applicable, for example `benchmark/results/ycsb/` and `benchmark/eunomia/results/`.
