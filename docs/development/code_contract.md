...
| `crates/nokvfs-cluster/` | Shared-log metadata replication contracts, log positions, durable receipts, checkpoint frontiers, and cluster test harnesses. | Own filesystem semantics, import Holt/FUSE/object/provider code, define wire compatibility shims, or execute metadata mutations directly. |
