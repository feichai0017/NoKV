...
- **Control plane** — which coordinator currently holds the Eunomia lease, lease
...
- **Topology diagram:** 3 truth-plane meta-root peers ↔ 3 control-plane
  ...
  in blue, the Eunomia lease holder in purple, and pulsing lines showing the
...
- **Event timeline:** auto-populated from expvar diffs — lease handoffs,
  ...
  this to watch the Eunomia lifecycle live.
...
- [docs/eunomia-audit.md](eunomia-audit.md) — the Eunomia audit tool behind the dashboard's
