...
The snapshot below is from a historical profile (`value_size=256`) and is kept
as a reference baseline. Re-run `scripts/run_benchmarks.sh` with defaults to
produce the official-aligned profile (`A-F`, `value_size=1000`).
