...
func TestLookupCacheHit(t *testing.T) {
	...
	record := fsmeta.DentryRecord{Parent: 7, Name: "run", Inode: 42, Type: fsmeta.InodeTypeDirectory}
...
func TestLookupCacheMissAndExpire(t *testing.T) {
	...
	cache.Put("vol", fsmeta.DentryRecord{Parent: 7, Name: "run", Inode: 42, Type: fsmeta.InodeTypeDirectory})
...
func TestLookupCachePutManyAndInvalidate(t *testing.T) {
	...
	cache.PutMany("vol", []fsmeta.DentryRecord{
		{Parent: 7, Name: "run-a", Inode: 42, Type: fsmeta.InodeTypeDirectory},
		{Parent: 7, Name: "run-b", Inode: 43, Type: fsmeta.InodeTypeDirectory},
	})
...
func TestLookupCacheEvictsLRU(t *testing.T) {
	...
	cache.Put("vol", fsmeta.DentryRecord{Parent: 7, Name: "a", Inode: 42, Type: fsmeta.InodeTypeFile})
	cache.Put("vol", fsmeta.DentryRecord{Parent: 7, Name: "b", Inode: 43, Type: fsmeta.InodeTypeFile})
