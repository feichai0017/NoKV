...
func (c *BufferedCommitter) CommitCapsule(ctx context.Context, id OperationID, delta compile.SemanticDelta) (CapsuleSeal, error) {
...
func (c *BufferedCommitter) GetCapsuleOverlay(key []byte) (value []byte, deleted bool, ok bool) {
	if c == nil {
...
func (c *BufferedCommitter) ScanCapsuleOverlay(start []byte, limit uint32) []OverlayKV {
	if c == nil || limit == 0 {
		return nil
	}
	c.overlayMu.RLock()
