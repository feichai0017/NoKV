...
var ErrReplayVersionRequired = errors.New("fsmeta capsule: replay version required")
...
// MVCCReplayStore materializes sealed Capsule effects into NoKV's existing
