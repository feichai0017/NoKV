...
var (
	...
	errPerasAuthorityClientRequired  = nokverrors.New(nokverrors.KindInvalidArgument, "fsmeta/runtime/raftstore: peras authority client required")
	errPerasAuthorityTableRequired   = nokverrors.New(nokverrors.KindInvalidArgument, "fsmeta/runtime/raftstore: peras authority table required")
	...
	errPerasAuthorityInvalidResponse = nokverrors.New(nokverrors.KindProtocolViolation, "fsmeta/runtime/raftstore: invalid peras authority response")
	errPerasAuthorityNotHeld         = nokverrors.New(nokverrors.KindNotLeader, "fsmeta/runtime/raftstore: peras authority is held by another holder")
)
