...
var (
	...
	errCapsuleAuthorityClientRequired  = nokverrors.New(nokverrors.KindInvalidArgument, "fsmeta/runtime/raftstore: capsule authority client required")
	...
	errCapsuleAuthorityInvalidResponse = nokverrors.New(nokverrors.KindProtocolViolation, "fsmeta/runtime/raftstore: invalid capsule authority response")
	errCapsuleAuthorityNotHeld         = nokverrors.New(nokverrors.KindNotLeader, "fsmeta/runtime/raftstore: capsule authority is held by another holder")
)
