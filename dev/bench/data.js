    ...
    "Benchmark": [
      {
        "commit": {
          ...
          "distinct": true,
          "id": "84a235bbb9a01ee4b3f3a6e2fb3ba7ac306ff63e",
          "message": "perf(wal): decouple WAL fsync from commit pipeline via sync worker (#123)\n\nIntroduce a dedicated syncWorker goroutine that coalesces WAL fsync \ncalls, so the commitWorker can continue applying new writes while a \nprevious fsync is in flight. This is gated behind the new \nSyncPipeline option (only effective when SyncWrites is true).\n\nKey changes:\n- Add syncBatch struct to carry committed-but-unsynced requests from  \n  commitWorker to syncWorker via a buffered channel.\n- syncWorker drains pending syncBatch items, issues a single fsync \n  for the whole batch, then acks all enclosed requests.\n- Extract ackCommitBatch() to unify error handling and pool recycling \n  for both inline-sync and pipelined paths.\n- Bump WAL default buffer size from 256 KiB to 4 MiB to better absorb \n  write bursts when fsync is pipelined.\n- Narrow the lock scope in wal.Manager.Sync(): hold mu only for Flush \n  release before the actual fsync to reduce contention.\n- Add RecordSync metrics (avg latency, coalesced batch count) \n  surfaced in WriteMetricsSnapshot and StatsSnapshot.\n- Refactor BenchmarkDBBatchSet: replace batchSet() with direct \n  sendToWriteCh() calls to bypass the batch-level mutex and measure \n  the raw commit-pipeline throughput more accurately. Also expand the \n  benchmark to cover NoSync / SyncInline / SyncPipeline modes for \n  easy comparison.\n- Add unit test for SyncPipeline WAL behavior",
          "timestamp": "2026-03-13T16:28:04+08:00",
          "tree_id": "c3adf510ab787aa49ddc012c097614026bd0a1ba",
          "url": "https://github.com/feichai0017/NoKV/commit/84a235bbb9a01ee4b3f3a6e2fb3ba7ac306ff63e"
        },
        "date": 1773390577346,
        "tool": "go",
        "benches": [
          {
            ...
            "value": 7737,
            "unit": "ns/op\t   4.14 MB/s\t    2310 B/op\t      17 allocs/op",
            "extra": "154135 times\n4 procs"
          },
          {
          ...
          },
          {
            ...
            "value": 18976,
            "unit": "ns/op\t 215.85 MB/s\t    2575 B/op\t      27 allocs/op",
            "extra": "70298 times\n4 procs"
          },
          {
          ...
          },
          {
            ...
            "value": 8281,
            "unit": "ns/op\t   7.73 MB/s\t   20034 B/op\t       8 allocs/op",
            "extra": "1000000 times\n4 procs"
          },
          {
          ...
          },
          {
            ...
            "value": 12300,
            "unit": "ns/op\t 333.00 MB/s\t   34321 B/op\t      11 allocs/op",
            "extra": "334612 times\n4 procs"
          },
          {
          ...
          },
          {
            ...
            "value": 69797,
            "unit": "ns/op\t 234.74 MB/s\t  191930 B/op\t     226 allocs/op",
            "extra": "17532 times\n4 procs"
          },
          {
          ...
          },
          {
            ...
            "value": 80688,
            "unit": "ns/op\t 203.05 MB/s\t  189671 B/op\t     224 allocs/op",
            "extra": "15470 times\n4 procs"
          },
          {
          ...
          },
          {
            ...
            "value": 68178,
            "unit": "ns/op\t 240.31 MB/s\t  188468 B/op\t     225 allocs/op",
            "extra": "18468 times\n4 procs"
          },
          {
          ...
          },
          {
            ...
            "value": 45539,
            "unit": "ns/op\t 179.89 MB/s\t   43391 B/op\t     210 allocs/op",
            "extra": "24463 times\n4 procs"
          },
          {
          ...
          },
          {
            ...
            "value": 6386599,
            "unit": "ns/op\t71593454 B/op\t     474 allocs/op",
            "extra": "188 times\n4 procs"
          },
          {
          ...
          },
          {
            ...
            "value": 573.5,
            "unit": "ns/op\t 111.59 MB/s\t    1543 B/op\t       0 allocs/op",
            "extra": "2186484 times\n4 procs"
          },
          {
          ...
          },
          {
            ...
            "value": 1371,
            "unit": "ns/op\t  46.67 MB/s\t     162 B/op\t       1 allocs/op",
            "extra": "1000000 times\n4 procs"
          },
          {
          ...
          },
          {
            ...
            "value": 451.8,
            "unit": "ns/op\t 141.64 MB/s\t     162 B/op\t       1 allocs/op",
            "extra": "3010058 times\n4 procs"
          },
          {
          ...
          },
          {
            ...
            "value": 1238,
            "unit": "ns/op\t  51.69 MB/s\t     162 B/op\t       1 allocs/op",
            "extra": "1000000 times\n4 procs"
          },
          {
          ...
          },
          {
            ...
            "value": 27654,
            "unit": "ns/op\t 296.23 MB/s\t    1794 B/op\t      35 allocs/op",
            "extra": "73532 times\n4 procs"
          },
          {
          ...
          },
          {
            ...
            "value": 164.7,
            "unit": "ns/op\t1554.68 MB/s\t     272 B/op\t       2 allocs/op",
            "extra": "7350277 times\n4 procs"
          },
          {
          ...
          },
          {
            ...
            "value": 1045,
            "unit": "ns/op\t 245.02 MB/s\t     444 B/op\t       9 allocs/op",
            "extra": "1000000 times\n4 procs"
          },
          {
          ...
          },
          {
            ...
            "value": 2595742,
            "unit": "ns/op\t 7475950 B/op\t   40016 allocs/op",
            "extra": "448 times\n4 procs"
          },
          {
