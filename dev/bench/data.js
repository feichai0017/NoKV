    ...
    "Benchmark": [
      {
        "commit": {
          ...
          "distinct": true,
          "id": "fefc4e3c7983560fd249e20e885155f6bd7ac672",
          "message": "fix(meta-root/transport): unblock leader election when one peer is unreachable\n\nThe raft transport's Send returned after the first failed peer, which meant\nthat when the leader died, the two surviving peers could not deliver\nMsgPreVote / MsgVote to each other: the batched Send tried the dead peer\nfirst, got an error, and dropped the rest of the messages on the floor. The\ncluster then got stuck in an endless pre-vote loop — each survivor sent its\nown PreVote, received 1 self-vote, never heard from the other survivor, and\nre-elected at the next tick.\n\nFix: iterate every message and fan out concurrently. One slow/dead peer's\nsendTimeout no longer serializes the healthy peers, and a Send-level error\nno longer truncates the per-peer loop. First error wins for observability.\nCombined with the earlier conn-invalidation-on-error, a peer that restarts\nunder the same DNS name but with a new IP becomes reachable again on the\nnext raft tick.\n\nVerified: `docker stop` the raft leader and writes recover in ~17-18s (raft\nelection + coord lease takeover through a single TTL window). Before the\nfix, writes stayed failed indefinitely and the two survivors looped in\npre-vote forever.\n\nCo-Authored-By: Claude Opus 4.7 (1M context) <noreply@anthropic.com>",
          "timestamp": "2026-04-22T19:50:40+10:00",
          "tree_id": "b1209823fb539d3aa1af22ead87cb6a58a34de8a",
          "url": "https://github.com/feichai0017/NoKV/commit/fefc4e3c7983560fd249e20e885155f6bd7ac672"
        },
        "date": 1776852273722,
        "tool": "go",
        "benches": [
          {
            ...
            "value": 4831,
            "unit": "ns/op\t   6.62 MB/s\t     424 B/op\t      13 allocs/op",
            "extra": "23532 times\n4 procs"
          },
          {
          ...
          },
          {
            ...
            "value": 12416,
            "unit": "ns/op\t 329.89 MB/s\t     398 B/op\t      20 allocs/op",
            "extra": "12306 times\n4 procs"
          },
          {
          ...
          },
          {
            ...
            "value": 5651,
            "unit": "ns/op\t 724.81 MB/s\t    9160 B/op\t       7 allocs/op",
            "extra": "25873 times\n4 procs"
          },
          {
          ...
          },
          {
            ...
            "value": 160560,
            "unit": "ns/op\t 102.04 MB/s\t  189228 B/op\t     147 allocs/op",
            "extra": "940 times\n4 procs"
          },
          {
          ...
          },
          {
            ...
            "value": 708346,
            "unit": "ns/op\t  23.13 MB/s\t   46675 B/op\t     148 allocs/op",
            "extra": "152 times\n4 procs"
          },
          {
          ...
          },
          {
            ...
            "value": 754329,
            "unit": "ns/op\t  21.72 MB/s\t   46695 B/op\t     149 allocs/op",
            "extra": "154 times\n4 procs"
          },
          {
          ...
          },
          {
            ...
            "value": 972.4,
            "unit": "ns/op\t  65.81 MB/s\t     159 B/op\t       1 allocs/op",
            "extra": "172075 times\n4 procs"
          },
          {
          ...
          },
          {
            ...
            "value": 389.8,
            "unit": "ns/op\t 164.17 MB/s\t     162 B/op\t       1 allocs/op",
            "extra": "368964 times\n4 procs"
          },
          {
          ...
          },
          {
            ...
            "value": 1011,
            "unit": "ns/op\t  63.29 MB/s\t     162 B/op\t       1 allocs/op",
            "extra": "377092 times\n4 procs"
          },
          {
          ...
          },
          {
            ...
            "value": 27101,
            "unit": "ns/op\t 302.28 MB/s\t   34644 B/op\t     210 allocs/op",
            "extra": "4260 times\n4 procs"
          },
          {
          ...
          },
          {
            ...
            "value": 36839,
            "unit": "ns/op\t 222.37 MB/s\t   34644 B/op\t     210 allocs/op",
            "extra": "2997 times\n4 procs"
          },
          {
          ...
          },
          {
            ...
            "value": 9014452,
            "unit": "ns/op\t71593350 B/op\t     475 allocs/op",
            "extra": "34 times\n4 procs"
          },
          {
          ...
          },
          {
            ...
            "value": 8707292,
            "unit": "ns/op\t71593596 B/op\t     476 allocs/op",
            "extra": "12 times\n4 procs"
          },
          {
          ...
          },
          {
            ...
            "value": 10590,
            "unit": "ns/op\t 773.54 MB/s\t    1795 B/op\t      35 allocs/op",
            "extra": "10000 times\n4 procs"
          },
          {
          ...
          },
          {
            ...
            "value": 170.1,
            "unit": "ns/op\t1505.17 MB/s\t     272 B/op\t       2 allocs/op",
            "extra": "682321 times\n4 procs"
          },
          {
          ...
          },
          {
            ...
            "value": 597.8,
            "unit": "ns/op\t 428.27 MB/s\t     440 B/op\t       9 allocs/op",
            "extra": "198483 times\n4 procs"
          },
          {
          ...
          },
          {
            ...
            "value": 2784504,
            "unit": "ns/op\t 7475890 B/op\t   40016 allocs/op",
            "extra": "42 times\n4 procs"
          },
          {
