...
const file_coordinator_coordinator_proto_rawDesc = "" +
	...
	"\x06mounts\x18\x01 \x03(\v2\x1e.nokv.coordinator.v1.MountInfoR\x06mounts\"\xbe\x01\n" +
	...
	"\x1cSYNC_HEALTH_ROOT_UNAVAILABLE\x10\x042\x90\n" +
	"\n" +
	"\vCoordinator\x12i\n" +
	...
	"\n" +
	"ListMounts\x12&.nokv.coordinator.v1.ListMountsRequest\x1a'.nokv.coordinator.v1.ListMountsResponse\x12i\n" +
...
var file_coordinator_coordinator_proto_msgTypes = make([]protoimpl.MessageInfo, 32)
var file_coordinator_coordinator_proto_goTypes = []any{
	...
	(*SchedulerOperation)(nil),          // 24: nokv.coordinator.v1.SchedulerOperation
	(*StoreHeartbeatResponse)(nil),      // 25: nokv.coordinator.v1.StoreHeartbeatResponse
	(*RegionLivenessRequest)(nil),       // 26: nokv.coordinator.v1.RegionLivenessRequest
	(*RegionLivenessResponse)(nil),      // 27: nokv.coordinator.v1.RegionLivenessResponse
	(*PublishRootEventRequest)(nil),     // 28: nokv.coordinator.v1.PublishRootEventRequest
	(*PublishRootEventResponse)(nil),    // 29: nokv.coordinator.v1.PublishRootEventResponse
	(*TransitionEntry)(nil),             // 30: nokv.coordinator.v1.TransitionEntry
	(*TransitionAssessment)(nil),        // 31: nokv.coordinator.v1.TransitionAssessment
	(*ListTransitionsRequest)(nil),      // 32: nokv.coordinator.v1.ListTransitionsRequest
	(*ListTransitionsResponse)(nil),     // 33: nokv.coordinator.v1.ListTransitionsResponse
	(*AssessRootEventRequest)(nil),      // 34: nokv.coordinator.v1.AssessRootEventRequest
	(*AssessRootEventResponse)(nil),     // 35: nokv.coordinator.v1.AssessRootEventResponse
	(*RemoveRegionRequest)(nil),         // 36: nokv.coordinator.v1.RemoveRegionRequest
	(*RemoveRegionResponse)(nil),        // 37: nokv.coordinator.v1.RemoveRegionResponse
	(*RootToken)(nil),                   // 38: nokv.coordinator.v1.RootToken
	(*GetRegionByKeyRequest)(nil),       // 39: nokv.coordinator.v1.GetRegionByKeyRequest
	(*GetRegionByKeyResponse)(nil),      // 40: nokv.coordinator.v1.GetRegionByKeyResponse
	(*AllocIDRequest)(nil),              // 41: nokv.coordinator.v1.AllocIDRequest
	(*AllocIDResponse)(nil),             // 42: nokv.coordinator.v1.AllocIDResponse
	(*TsoRequest)(nil),                  // 43: nokv.coordinator.v1.TsoRequest
	(*TsoResponse)(nil),                 // 44: nokv.coordinator.v1.TsoResponse
	(*meta.RootCursor)(nil),             // 45: nokv.meta.v1.RootCursor
	(*meta.RootEvent)(nil),              // 46: nokv.meta.v1.RootEvent
	(*meta.RootPendingPeerChange)(nil),  // 47: nokv.meta.v1.RootPendingPeerChange
	(*meta.RootPendingRangeChange)(nil), // 48: nokv.meta.v1.RootPendingRangeChange
	(*meta.RegionDescriptor)(nil),       // 49: nokv.meta.v1.RegionDescriptor
}
var file_coordinator_coordinator_proto_depIdxs = []int32{
	...
	45, // 4: nokv.coordinator.v1.MountInfo.registered_at:type_name -> nokv.meta.v1.RootCursor
	45, // 5: nokv.coordinator.v1.MountInfo.retired_at:type_name -> nokv.meta.v1.RootCursor
	...
	2,  // 8: nokv.coordinator.v1.SchedulerOperation.type:type_name -> nokv.coordinator.v1.SchedulerOperationType
	24, // 9: nokv.coordinator.v1.StoreHeartbeatResponse.operations:type_name -> nokv.coordinator.v1.SchedulerOperation
	46, // 10: nokv.coordinator.v1.PublishRootEventRequest.event:type_name -> nokv.meta.v1.RootEvent
	31, // 11: nokv.coordinator.v1.PublishRootEventResponse.assessment:type_name -> nokv.coordinator.v1.TransitionAssessment
	3,  // 12: nokv.coordinator.v1.TransitionEntry.kind:type_name -> nokv.coordinator.v1.TransitionKind
	4,  // 13: nokv.coordinator.v1.TransitionEntry.status:type_name -> nokv.coordinator.v1.TransitionStatus
	5,  // 14: nokv.coordinator.v1.TransitionEntry.retry_class:type_name -> nokv.coordinator.v1.TransitionRetryClass
	6,  // 15: nokv.coordinator.v1.TransitionEntry.reason:type_name -> nokv.coordinator.v1.TransitionReason
	47, // 16: nokv.coordinator.v1.TransitionEntry.pending_peer_change:type_name -> nokv.meta.v1.RootPendingPeerChange
	48, // 17: nokv.coordinator.v1.TransitionEntry.pending_range_change:type_name -> nokv.meta.v1.RootPendingRangeChange
	3,  // 18: nokv.coordinator.v1.TransitionAssessment.kind:type_name -> nokv.coordinator.v1.TransitionKind
	4,  // 19: nokv.coordinator.v1.TransitionAssessment.status:type_name -> nokv.coordinator.v1.TransitionStatus
	5,  // 20: nokv.coordinator.v1.TransitionAssessment.retry_class:type_name -> nokv.coordinator.v1.TransitionRetryClass
	6,  // 21: nokv.coordinator.v1.TransitionAssessment.reason:type_name -> nokv.coordinator.v1.TransitionReason
	7,  // 22: nokv.coordinator.v1.TransitionAssessment.decision:type_name -> nokv.coordinator.v1.TransitionDecision
	30, // 23: nokv.coordinator.v1.ListTransitionsResponse.entries:type_name -> nokv.coordinator.v1.TransitionEntry
	46, // 24: nokv.coordinator.v1.AssessRootEventRequest.event:type_name -> nokv.meta.v1.RootEvent
	31, // 25: nokv.coordinator.v1.AssessRootEventResponse.assessment:type_name -> nokv.coordinator.v1.TransitionAssessment
	8,  // 26: nokv.coordinator.v1.GetRegionByKeyRequest.freshness:type_name -> nokv.coordinator.v1.Freshness
	38, // 27: nokv.coordinator.v1.GetRegionByKeyRequest.required_root_token:type_name -> nokv.coordinator.v1.RootToken
	49, // 28: nokv.coordinator.v1.GetRegionByKeyResponse.region_descriptor:type_name -> nokv.meta.v1.RegionDescriptor
	38, // 29: nokv.coordinator.v1.GetRegionByKeyResponse.served_root_token:type_name -> nokv.coordinator.v1.RootToken
	8,  // 30: nokv.coordinator.v1.GetRegionByKeyResponse.served_freshness:type_name -> nokv.coordinator.v1.Freshness
	9,  // 31: nokv.coordinator.v1.GetRegionByKeyResponse.degraded_mode:type_name -> nokv.coordinator.v1.DegradedMode
	38, // 32: nokv.coordinator.v1.GetRegionByKeyResponse.current_root_token:type_name -> nokv.coordinator.v1.RootToken
	10, // 33: nokv.coordinator.v1.GetRegionByKeyResponse.catch_up_state:type_name -> nokv.coordinator.v1.CatchUpState
	11, // 34: nokv.coordinator.v1.GetRegionByKeyResponse.serving_class:type_name -> nokv.coordinator.v1.ServingClass
	12, // 35: nokv.coordinator.v1.GetRegionByKeyResponse.sync_health:type_name -> nokv.coordinator.v1.SyncHealth
	13, // 36: nokv.coordinator.v1.Coordinator.StoreHeartbeat:input_type -> nokv.coordinator.v1.StoreHeartbeatRequest
	15, // 37: nokv.coordinator.v1.Coordinator.GetStore:input_type -> nokv.coordinator.v1.GetStoreRequest
	17, // 38: nokv.coordinator.v1.Coordinator.ListStores:input_type -> nokv.coordinator.v1.ListStoresRequest
	20, // 39: nokv.coordinator.v1.Coordinator.GetMount:input_type -> nokv.coordinator.v1.GetMountRequest
	22, // 40: nokv.coordinator.v1.Coordinator.ListMounts:input_type -> nokv.coordinator.v1.ListMountsRequest
	26, // 41: nokv.coordinator.v1.Coordinator.RegionLiveness:input_type -> nokv.coordinator.v1.RegionLivenessRequest
	28, // 42: nokv.coordinator.v1.Coordinator.PublishRootEvent:input_type -> nokv.coordinator.v1.PublishRootEventRequest
	32, // 43: nokv.coordinator.v1.Coordinator.ListTransitions:input_type -> nokv.coordinator.v1.ListTransitionsRequest
	34, // 44: nokv.coordinator.v1.Coordinator.AssessRootEvent:input_type -> nokv.coordinator.v1.AssessRootEventRequest
	36, // 45: nokv.coordinator.v1.Coordinator.RemoveRegion:input_type -> nokv.coordinator.v1.RemoveRegionRequest
	39, // 46: nokv.coordinator.v1.Coordinator.GetRegionByKey:input_type -> nokv.coordinator.v1.GetRegionByKeyRequest
	41, // 47: nokv.coordinator.v1.Coordinator.AllocID:input_type -> nokv.coordinator.v1.AllocIDRequest
	43, // 48: nokv.coordinator.v1.Coordinator.Tso:input_type -> nokv.coordinator.v1.TsoRequest
	25, // 49: nokv.coordinator.v1.Coordinator.StoreHeartbeat:output_type -> nokv.coordinator.v1.StoreHeartbeatResponse
	16, // 50: nokv.coordinator.v1.Coordinator.GetStore:output_type -> nokv.coordinator.v1.GetStoreResponse
	18, // 51: nokv.coordinator.v1.Coordinator.ListStores:output_type -> nokv.coordinator.v1.ListStoresResponse
	21, // 52: nokv.coordinator.v1.Coordinator.GetMount:output_type -> nokv.coordinator.v1.GetMountResponse
	23, // 53: nokv.coordinator.v1.Coordinator.ListMounts:output_type -> nokv.coordinator.v1.ListMountsResponse
	27, // 54: nokv.coordinator.v1.Coordinator.RegionLiveness:output_type -> nokv.coordinator.v1.RegionLivenessResponse
	29, // 55: nokv.coordinator.v1.Coordinator.PublishRootEvent:output_type -> nokv.coordinator.v1.PublishRootEventResponse
	33, // 56: nokv.coordinator.v1.Coordinator.ListTransitions:output_type -> nokv.coordinator.v1.ListTransitionsResponse
	35, // 57: nokv.coordinator.v1.Coordinator.AssessRootEvent:output_type -> nokv.coordinator.v1.AssessRootEventResponse
	37, // 58: nokv.coordinator.v1.Coordinator.RemoveRegion:output_type -> nokv.coordinator.v1.RemoveRegionResponse
	40, // 59: nokv.coordinator.v1.Coordinator.GetRegionByKey:output_type -> nokv.coordinator.v1.GetRegionByKeyResponse
	42, // 60: nokv.coordinator.v1.Coordinator.AllocID:output_type -> nokv.coordinator.v1.AllocIDResponse
	44, // 61: nokv.coordinator.v1.Coordinator.Tso:output_type -> nokv.coordinator.v1.TsoResponse
...
func file_coordinator_coordinator_proto_init() {
	...
	file_coordinator_coordinator_proto_msgTypes[26].OneofWrappers = []any{}
	type x struct{}
