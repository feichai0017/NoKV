...
const (
	...
	MetadataPredicateKind_METADATA_PREDICATE_KIND_PREFIX_EMPTY MetadataPredicateKind = 3
)
...
var (
	MetadataPredicateKind_name = map[int32]string{
		...
		3: "METADATA_PREDICATE_KIND_PREFIX_EMPTY",
	}
...
const file_metadata_metadata_proto_rawDesc = "" +
	...
	"\x17METADATA_FAMILY_SEGMENT\x10\f*\xb7\x01\n" +
