...
func (s *coordinatorRootStorage) ApplyCapsuleAuthority(_ context.Context, _ rootproto.CapsuleAuthorityCommand) (rootstate.State, rootproto.CapsuleAuthorityGrant, error) {
	s.mu.Lock()
	defer s.mu.Unlock()
