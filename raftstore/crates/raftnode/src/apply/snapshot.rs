use nokv_metadata_state::{MetadataEngine, MetadataSnapshotEngine};
use nokv_proto::nokv::meta::v1 as metapb;
use prost::Message;

use super::{AppliedMetadataEngine, ApplyStatus, PersistentAppliedMetadataEngine};
use crate::storage::{decode_region_snapshot_payload, RegionSnapshotPayload};
    ...
    E: MetadataEngine + MetadataSnapshotEngine,
{
    ...
    fn export_region_snapshot(&self) -> nokv_metadata_state::Result<Vec<u8>> {
        ...
        Ok(RegionSnapshotPayload {
            ...
            metadata_snapshot: nokv_metadata_state::encode_metadata_snapshot(&metadata_snapshot),
    ...
    fn install_region_snapshot(&self, snapshot: &[u8]) -> nokv_metadata_state::Result<ApplyStatus> {
        ...
        let metadata_snapshot =
            nokv_metadata_state::decode_metadata_snapshot(&payload.metadata_snapshot)?;
